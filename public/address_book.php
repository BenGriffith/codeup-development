		...
		try {
			...
			foreach ($entry as $key => $value) {
				...
				if (empty($value)) {
					...
					// If $value is empty printing an error message to the screen
					throw new InputException("Please don't leave the $key field empty.");
				...
				// If $value has more than 125 characters an error message is printed to the screen
				if (strlen($value) > 125) {
					throw new InputException("$key must be less than 125 characters.");	
				}
			}			
